...
public class ExItemData_importer : AssetPostprocessor {
	private static readonly string filePath = "Assets/Resources/ExItemData.xlsx";
	private static readonly string exportPath = "Assets/Resources/ExItemData.asset";
		...
		foreach (string asset in importedAssets) {
			...
			using (FileStream stream = File.Open (filePath, FileMode.Open, FileAccess.Read, FileShare.ReadWrite)) {
				...
				foreach(string sheetName in sheetNames) {
					...
					cell = row.GetCell(2); p.itemText = (cell == null ? "" : cell.StringCellValue);
